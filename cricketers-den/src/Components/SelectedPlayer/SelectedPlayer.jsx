...
const SelectedPlayer = ({ player, num, handleDeleteSelected }) => {
        ...
        <>
            ...
            <ul className="list bg-base-100 rounded-box shadow-md border-2 border-gray-300 my-2">
                <li className="list-row flex items-center justify-between p-4">
                    ...
                    <button onClick={() => { handleDeleteSelected(id, price) }} className="btn btn-square btn-ghost">
                        <MdDeleteForever className="size-[2.2em] text-red-500" />
                    </button>
                </li>
            </ul>
